  ...
  grunt.initConfig({
    ...
    copy: {
      public: {
        files: [{
          ...
          src: ['jquery/dist/jquery.min.js',
                ...
                'chart.js/dist/chart.min.js','mobile-angular-ui/dist/js/mobile-angular-ui.min.js',
      ...
      publicstyles: {
        expand: true,
        cwd: 'bower_components',
        src: ['bootstrap/dist/css/bootstrap.min.css','jquery-confirm2/dist/jquery-confirm.min.css'],
      ...
      html: {
        expand: true,
        cwd: '<%= pkg.srcPath %>',
        src: ['index_*.html','p/minn/views/**/*.html'],
        dest: '<%= pkg.dist %>'
      },
      scripts: {
        expand: true,
    ...
    concurrent: {
      ...
      watch: {
        ...
        html: {
        files: ["<%= pkg.srcPath %>/index_*.html","<%= pkg.srcPath %>/p/minn/views/**/*.html"],
